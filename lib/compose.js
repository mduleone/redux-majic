...
function composeRequest(data, schema) {
    ...
    var responseData = _extends({
        id: id,
        type: type
    }, (0, _utils.isEmpty)(attributes) ? {} : { attributes: attributes }, (0, _utils.isEmpty)(relationships) ? {} : { relationships: relationships }, (0, _utils.isEmpty)(meta) ? {} : { meta: meta });

    return _extends({
        data: [responseData]
    }, (0, _utils.isEmpty)(included) ? {} : { included: included }, (0, _utils.isEmpty)(topLevelMeta) ? {} : { meta: topLevelMeta });
}
...
function buildRelationship(relation, schema) {
    ...
    } else if (relation.data && !(0, _utils.isEmpty)(relation.data)) {
        data = {
            id: relation.data.id,
    ...
    return _extends({}, (0, _utils.isEmpty)(meta) ? {} : { meta: meta }, (0, _utils.isEmpty)(data) ? {} : { data: data });
}
